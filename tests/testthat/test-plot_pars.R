test_that("plot_pars() works", {
  ...
  expect_doppelganger("proc-full", plot_pars(proc, plot.type = "full", cov.labs = cov.labs))
  expect_doppelganger("proc-cv", plot_pars(proc, plot.type = "cv", cov.labs = cov.labs))
  
  
  expect_doppelganger("obs-full", plot_pars(obs, plot.type = "full", cov.labs = cov.labs))
  expect_doppelganger("obs-cv", plot_pars(obs, plot.type = "cv", cov.labs = cov.labs))
  
  
  expect_doppelganger("alpha-full", plot_pars(alpha, plot.type = "full", cov.labs = cov.labs))
  expect_doppelganger("alpha-cv", plot_pars(alpha, plot.type = "cv", cov.labs = cov.labs))
  
  
  expect_doppelganger("tau-full", plot_pars(tau, plot.type = "full", cov.labs = cov.labs))
  expect_doppelganger("tau-cv", plot_pars(tau, plot.type = "cv", cov.labs = cov.labs))
