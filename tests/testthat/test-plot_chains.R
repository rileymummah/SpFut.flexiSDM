...
#   expect_doppelganger("B chains1", out1$plot)
# 
#   out2 <- plot_chains(samples = mod1$samples, data = mod1$data, constants = mod1$constants, cov.labs = cov.labs, plot = "alpha", cutoff = 0)
#   expect_doppelganger("alpha chains1", out2$plot)
# 
#   out3 <- plot_chains(mod1$samples, data = mod1$data, constants = mod1$constants, cov.labs = cov.labs, plot = "observation", cutoff = 0)
#   expect_doppelganger("observation chains1", out3$plot)
# 
#   expect_warning(out4 <- plot_chains(mod1$samples, data = mod1$data, constants = mod1$constants, cov.labs = cov.labs, plot = "tau", cutoff = 0))
# 
# 
