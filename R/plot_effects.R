...
plot_effects <- function(data,
  ...
  for (n in 1:length(covs)) {
    ...
    if (length(ind2) == 0 & length(ind3) > 0) {
      ...
      # Fix this for updated package
      stop("Cannot plot parameters with interactions")
